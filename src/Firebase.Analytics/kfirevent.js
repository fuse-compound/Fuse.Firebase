...
/// to your app.
kFIREvent.AddPaymentInfo = "add_payment_info";
...
/// </ul>
kFIREvent.AddToCart = "add_to_cart";
...
///     <li>{@link kFIRParameterValue} (double as NSNumber) (optional)</li>
/// </ul>
kFIREvent.AddToWishlist = "add_to_wishlist";
...
/// </ul>
kFIREvent.BeginCheckout = "begin_checkout";
...
/// </ul>
kFIREvent.EarnVirtualCurrency = "earn_virtual_currency";
...
///     <li>{@link kFIRParameterTravelClass} (NSString) (optional) for travel bookings</li>
/// </ul>
kFIREvent.EcommercePurchase = "ecommerce_purchase";
...
///     <li>{@link kFIRParameterValue} (double as NSNumber) (optional)</li>
/// </ul>
kFIREvent.GenerateLead = "generate_lead";
...
/// </ul>
kFIREvent.JoinGroup = "join_group";
...
///     <li>{@link kFIRParameterCharacter} (NSString) (optional)</li>
/// </ul>
kFIREvent.PostScore = "post_score";
...
///     <li>{@link kFIRParameterValue} (double as NSNumber) (optional)</li>
/// </ul>
kFIREvent.PresentOffer = "present_offer";
...
///     <li>{@link kFIRParameterTransactionID} (NSString) (optional)</li>
/// </ul>
kFIREvent.PurchaseRefund = "purchase_refund";
...
///     <li>{@link kFIRParameterItemID} (NSString)</li>
/// </ul>
kFIREvent.SelectContent = "select_content";
...
///     <li>{@link kFIRParameterValue} (signed 64-bit integer or double as NSNumber)</li>
/// </ul>
kFIREvent.SpendVirtualCurrency = "spend_virtual_currency";
...
kFIREvent.TutorialBegin = "tutorial_begin";
...
/// on-boarding process.
kFIREvent.TutorialComplete = "tutorial_complete";
...
/// </ul>
kFIREvent.UnlockAchievement = "unlock_achievement";
...
///     <li>{@link kFIRParameterItemCategory} (NSString)</li>
/// </ul>
kFIREvent.ViewItemList = "view_item_list";
...
///     <li>{@link kFIRParameterSearchTerm} (NSString)</li>
/// </ul>
kFIREvent.ViewSearchResults = "view_search_results";
